!(function (e) {
  ...
  ((i = (function () {
  ...
  })()).prototype.addSlide = i.prototype.slickAdd =
    function (i, t, o) {
      var s = this;
    ...
    (i.prototype.asNavFor = function (i) {
      ...
      t && null !== t && (t = e(t).not(this.$slider)),
        null !== t &&
          "object" == typeof t &&
          t.each(function () {
    ...
    (i.prototype.buildArrows = function () {
      ...
      !0 === i.options.arrows &&
        ...
        i.$prevArrow.attr("aria-label", "Previous"),
        i.$nextArrow.attr("aria-label", "Next"),
    ...
    (i.prototype.buildDots = function () {
      ...
      if (!0 === o.options.dots && o.slideCount > o.options.slidesToShow) {
        for (
          t = '<ul class="' + o.options.dotsClass + '">', i = 0;
          i <= o.getDotCount();
          i += 1
        )
    ...
    (i.prototype.cleanUpEvents = function () {
      ...
      i.options.dots &&
        ...
        !0 === i.options.pauseOnDotsHover &&
          ...
          e("li", i.$dots)
            .off("mouseenter.slick", e.proxy(i.setPaused, i, !0))
            .off("mouseleave.slick", e.proxy(i.setPaused, i, !1))),
        !0 === i.options.arrows &&
          i.slideCount > i.options.slidesToShow &&
            ...
            s.slideCount % s.options.slidesToScroll != 0 &&
              ...
              (e > s.slideCount
                ? ((s.slideOffset =
                    ...
                    s.slideWidth *
                    -1),
                  (n = (s.options.slidesToShow - (e - s.slideCount)) * t * -1))
                : ((s.slideOffset =
      ...
      return (
        ...
        !0 === o.options.swipeToSlide
          ? (o.$slideTrack.find(".slick-slide").each(function (s, n) {
              return n.offsetLeft - t + e(n).outerWidth() / 2 > -1 * o.swipeLeft
                ? ((i = n), !1)
                : void 0;
            }),
    ...
    (i.prototype.initDotEvents = function () {
      ...
      !0 === i.options.dots &&
        ...
        !0 === i.options.dots &&
          ...
          !0 === i.options.autoplay &&
          e("li", i.$dots)
            .on("mouseenter.slick", e.proxy(i.setPaused, i, !0))
            .on("mouseleave.slick", e.proxy(i.setPaused, i, !1));
    }),
    ...
    (i.prototype.progressiveLazyLoad = function () {
      var i,
        t = this;
      e("img[data-lazy]", t.$slider).length > 0 &&
        ((i = e("img[data-lazy]", t.$slider).first()).attr("src", null),
        i
    ...
    (i.prototype.refresh = function (i) {
      ...
      (o = s.slideCount - s.options.slidesToShow),
        s.options.infinite ||
          (s.slideCount <= s.options.slidesToShow
            ? (s.currentSlide = 0)
            : s.currentSlide > o && (s.currentSlide = o)),
        (t = s.currentSlide),
        s.destroy(!0),
    ...
    (i.prototype.setPaused = function (e) {
      ...
      !0 === i.options.autoplay &&
        ...
        ((i.paused = e), e ? i.autoPlayClear() : i.autoPlay());
    }),
        ...
        a.slideCount <= a.options.slidesToShow
          ...
          : (!1 === i && a.asNavFor(e),
            ...
            (!1 === a.options.infinite &&
              ...
              (0 > e || e > a.getDotCount() * a.options.slidesToScroll)) ||
            (!1 === a.options.infinite &&
              !0 === a.options.centerMode &&
              (0 > e || e > a.slideCount - a.options.slidesToScroll))
              ? void (
                  !1 === a.options.fade &&
                  ((o = a.currentSlide),
                  !0 !== t
          ...
          "vertical" !== (t = r.swipeDirection())
            ? (void 0 !== e.originalEvent &&
              ...
              !1 === r.options.vertical
                ? (r.swipeLeft = i + o * s)
                : (r.swipeLeft = i + o * (r.$list.height() / r.listWidth) * s),
...
var slickSettings = {
  prevArrow:
    '<a href="javascript:void(0);" class="slick-prev"><span class="novicon novicon-arrow-left" aria-selected="false"></span></a>',
  nextArrow:
    '<a href="javascript:void(0);" class="slick-next"><span class="novicon novicon-arrow-right" aria-selected="false"></span></a>',
  swipeToSlide: !0,
  accessibility: !0,
};
$(function () {
  "function" == typeof imagesLoaded
    ? $("[data-slick]").each(function () {
        $(this)
          .imagesLoaded()
          .always(function (e) {
            $(e.elements).slick(slickSettings);
          });
      })
    : $("[data-slick]").each(function () {
        $(this).slick(slickSettings);
      }),
    $(document).on("keyup", ".slick-dots li", function (e) {
      37 == e.keyCode && $(this).closest(".slick-slider").slick("slickPrev"),
        39 == e.keyCode && $(this).closest(".slick-slider").slick("slickNext");
    });
}),
  /*!
  ...
  function () {
    function e() {}
    function i(e, i) {
      for (var t = e.length; t--; ) if (e[t].listener === i) return t;
      return -1;
    }
    function t(e) {
      return function () {
    ...
    (o.getListeners = function (e) {
      ...
      if ("object" == typeof e)
        for (t in ((i = {}), o))
          o.hasOwnProperty(t) && e.test(t) && (i[t] = o[t]);
      else i = o[e] || (o[e] = []);
      return i;
    }),
      (o.flattenListeners = function (e) {
        var i,
          t = [];
        for (i = 0; e.length > i; i += 1) t.push(e[i].listener);
        return t;
      }),
      (o.getListenersAsObject = function (e) {
        var i,
          t = this.getListeners(e);
        return t instanceof Array && ((i = {})[e] = t), i || t;
      }),
      (o.addListener = function (e, t) {
        ...
        for (o in s)
          s.hasOwnProperty(o) &&
            -1 === i(s[o], t) &&
            s[o].push(n ? t : { listener: t, once: !1 });
        return this;
      }),
      (o.on = t("addListener")),
      (o.addOnceListener = function (e, i) {
        return this.addListener(e, { listener: i, once: !0 });
      }),
      (o.once = t("addOnceListener")),
      (o.defineEvent = function (e) {
        return this.getListeners(e), this;
      }),
      (o.defineEvents = function (e) {
        for (var i = 0; e.length > i; i += 1) this.defineEvent(e[i]);
        return this;
      }),
      (o.removeListener = function (e, t) {
        ...
        for (s in n)
          n.hasOwnProperty(s) && -1 !== (o = i(n[s], t)) && n[s].splice(o, 1);
        return this;
      }),
      (o.off = t("removeListener")),
      (o.addListeners = function (e, i) {
        return this.manipulateListeners(!1, e, i);
      }),
      (o.removeListeners = function (e, i) {
        return this.manipulateListeners(!0, e, i);
      }),
      (o.manipulateListeners = function (e, i, t) {
        var o,
          s,
          n = e ? this.removeListener : this.addListener,
          r = e ? this.removeListeners : this.addListeners;
        if ("object" != typeof i || i instanceof RegExp)
          for (o = t.length; o--; ) n.call(this, i, t[o]);
        else
          for (o in i)
            i.hasOwnProperty(o) &&
              (s = i[o]) &&
      ...
      (o.removeAllListeners = t("removeEvent")),
      (o.emitEvent = function (e, i) {
        var t,
          o,
          s,
          n = this.getListenersAsObject(e);
        for (s in n)
          if (n.hasOwnProperty(s))
            for (o = n[s].length; o--; )
              !0 === (t = n[s][o]).once && this.removeListener(e, t.listener),
                t.listener.apply(this, i || []) ===
                  this._getOnceReturnValue() &&
                  this.removeListener(e, t.listener);
        return this;
      }),
      (o.trigger = t("emitEvent")),
      (o.emit = function (e) {
  ...
  (function (e) {
    function i(i) {
      var t = e.event;
      return (t.target = t.target || t.srcElement || i), t;
    }
  ...
  (function (e, i) {
    "function" == typeof define && define.amd
      ...
      : (e.imagesLoaded = i(e, e.EventEmitter, e.eventie));
    ...
    function s(e) {
      ...
      if (
        ...
        for (var t = 0, o = e.length; o > t; t++) i.push(e[t]);
      else i.push(e);
      return i;
    }
    function n(e, i, t) {
      ...
      "string" == typeof e && (e = document.querySelectorAll(e)),
        ...
        "function" == typeof i ? (t = i) : o(this.options, i),
        t && this.on("always", t),
        this.getImages(),
    ...
    (n.prototype = new i()),
      ...
      (n.prototype.getImages = function () {
        ...
        for (var e = 0, i = this.elements.length; i > e; e++) {
          ...
          if (o && (1 === o || 9 === o || 11 === o))
            for (
              var s = t.querySelectorAll("img"), n = 0, r = s.length;
              r > n;
              n++
            ) {
              var l = s[n];
      ...
      (n.prototype.check = function () {
        function e(e, s) {
          return (
            i.options.debug && c && d.log("confirm", e, s),
            i.progress(e),
            ++t === o && i.complete(),
            !0
          );
      ...
      (n.prototype.progress = function (e) {
        ...
        setTimeout(function () {
          i.emit("progress", i, e),
            i.jqDeferred && i.jqDeferred.notify && i.jqDeferred.notify(i, e);
        });
      }),
      ...
      a &&
        (a.fn.imagesLoaded = function (e, i) {
          return new n(this, e, i).jqDeferred.promise(a(this));
        }),
      (r.prototype = new i()),
      (r.prototype.check = function () {
        var e = u[this.img.src] || new l(this.img.src);
      ...
      (r.prototype.confirm = function (e, i) {
        (this.isLoaded = e), this.emit("confirm", this, i);
      });
    var u = {};
    return (
      (l.prototype = new i()),
      ...
      (l.prototype.confirm = function (e, i) {
        (this.isConfirmed = !0),
          (this.isLoaded = e),
          this.emit("confirm", this, i);
      }),
